...
namespace MyCaseLog
{
    public partial class SelectArea : Form
    {
        ...
        public SelectArea()
        {
            ...
            this.Opacity = .4D; //Make trasparent
        ...
        {
            e.Graphics.FillRectangle(Brushes.Lime, Top);
            e.Graphics.FillRectangle(Brushes.Lime, Left);
            e.Graphics.FillRectangle(Brushes.Lime, Right);
            e.Graphics.FillRectangle(Brushes.Lime, Bottom);
        }
